...
public class RobotMap {
    ...
    public static DoubleSolenoid liftDoubleSolenoidHook;
    ...
    public static void init() {
        ...
        liftDoubleSolenoidHook = new DoubleSolenoid(0, 4, 5);
        LiveWindow.addActuator("Lift", "Double Solenoid Hook", liftDoubleSolenoidHook);

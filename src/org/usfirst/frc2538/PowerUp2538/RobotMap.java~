...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainTalonSRX1 = new WPI_TalonSRX(9);
        
        
        driveTrainTalonSRX3 = new WPI_TalonSRX(5);
        ...
        elevatorTalonSRX42 = new WPI_TalonSRX(19);
        
        
        elevatorTalonSRX5 = new WPI_TalonSRX(15);

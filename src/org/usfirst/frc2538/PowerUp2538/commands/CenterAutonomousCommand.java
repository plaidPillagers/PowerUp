 ...
 *
 */
public class CenterAutonomousCommand extends Command {
    ...
    protected void execute() {
    	if (Robot.goLeft) {
    		SmartDashboard.putString("auto selection", "centerleft");
    	} else {
    		SmartDashboard.putString("auto selection", "centerright");
    	}
    }

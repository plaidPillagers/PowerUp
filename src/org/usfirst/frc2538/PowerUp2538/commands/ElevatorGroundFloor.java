 ...
 *
 */
public class ElevatorGroundFloor extends Command {
    ...
    private int groundFloorHeight = 5500; 
    
    // Called just before this Command runs the first time
    @Override
    protected void initialize() {
    	Robot.elevator.turnManualOff();
    	int targetDistance = groundFloorHeight; // a bit above the limit switch
    ...
    protected boolean isFinished() {
        return Robot.elevator.isNear(groundFloorHeight);
    }

...
public class Lift extends Subsystem {
    ...
    private final DoubleSolenoid doubleSolenoidHook = RobotMap.liftDoubleSolenoidHook;
    ...
    public void lowerFrame(){
  	 ...
  	 public void toggleHook(){
  		 if (hookUp){
  			 doubleSolenoidHook.set(DoubleSolenoid.Value.kReverse);
  			 hookUp = false;
  		 }else{
  			 doubleSolenoidHook.set(DoubleSolenoid.Value.kForward); 
  			 hookUp = true;
  		 }
  	 }

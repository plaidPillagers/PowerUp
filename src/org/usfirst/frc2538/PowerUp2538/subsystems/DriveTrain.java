...
public class DriveTrain extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
   	 ...
   	 public boolean driveAngle(double x,double y, double width){
   		 if (centerMotor.getSensorCollection().getQuadraturePosition()<centerEncoderValue+width){
   	 ...
   	 public double findRearDistance(){
   		 ...
   		 rv= gyro.getAngle();
   		 SmartDashboard.putNumber("Gyro angle", rv);
   		 rv= accelerometer.getX();
   		 SmartDashboard.putNumber("accelerometer X axis", rv);
   		 rv= accelerometer.getY();
   		 SmartDashboard.putNumber("accelerometer Y axis", rv);
   		 rv= accelerometer.getZ();
